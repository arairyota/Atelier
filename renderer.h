...
public:
	...
	static void SetWorldViewProjection2D(XMFLOAT2 position = XMFLOAT2(0.0f, 0.0f), XMFLOAT2 rotation = XMFLOAT2(0.0f, 0.0f), XMFLOAT2 scale = XMFLOAT2(1.0f, 1.0f), XMMATRIX mtx = XMMatrixIdentity());
	...
	static ID3D11DepthStencilView* getDepth() { return m_DepthStencilView; };
